...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Event.additional_information'
        db.add_column('events_event', 'additional_information', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Event.additional_information'
        db.delete_column('events_event', 'additional_information')
