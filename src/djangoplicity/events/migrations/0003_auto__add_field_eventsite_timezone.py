...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'EventSite.timezone'
        db.add_column('events_eventsite', 'timezone', self.gf('django.db.models.fields.CharField')(default='Europe/Berlin', max_length=40), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'EventSite.timezone'
        db.delete_column('events_eventsite', 'timezone')
