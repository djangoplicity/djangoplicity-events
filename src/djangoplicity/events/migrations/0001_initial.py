...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'EventSite'
        db.create_table('events_eventsite', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('slug', self.gf('django.db.models.fields.SlugField')(max_length=50, db_index=True)),
        ))
        db.send_create_signal('events', ['EventSite'])

        # Adding model 'EventSeries'
        db.create_table('events_eventseries', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('slug', self.gf('django.db.models.fields.SlugField')(max_length=50, db_index=True)),
        ))
        db.send_create_signal('events', ['EventSeries'])
        ...
        db.create_table('events_eventlocation', (
            ...
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('slug', self.gf('django.db.models.fields.SlugField')(max_length=50, db_index=True)),
            ('site', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['events.EventSite'], null=True, blank=True)),
        ))
        ...
        db.create_table('events_event', (
            ...
            ('location', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['events.EventLocation'], null=True, blank=True)),
            ('series', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['events.EventSeries'], null=True, blank=True)),
            ('type', self.gf('django.db.models.fields.CharField')(default='M', max_length=1, db_index=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('speaker', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'EventSite'
        db.delete_table('events_eventsite')

        # Deleting model 'EventSeries'
        db.delete_table('events_eventseries')
    ...
    models = {
        'events.event': {
            ...
            'type': ('django.db.models.fields.CharField', [], {'default': "'M'", 'max_length': '1', 'db_index': 'True'})
        },
        ...
        'media.color': {
            ...
            'id': ('django.db.models.fields.SlugField', [], {'max_length': '10', 'primary_key': 'True', 'db_index': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'upper_limit': ('django.db.models.fields.FloatField', [], {'null': 'True'})
        },
        'media.image': {
            'Meta': {'ordering': "['-priority', '-release_date']", 'object_name': 'Image'},
            'colors': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['media.Color']", 'through': "orm['media.ImageColor']", 'symmetrical': 'False'}),
            ...
            'id': ('djangoplicity.metadata.archives.fields.AVMIdField', [], {'max_length': '50', 'primary_key': 'True', 'db_index': 'True'}),
            ...
            'publisher_id': ('djangoplicity.metadata.archives.fields.AVMPublisherIdField', [], {'default': "u'vamp://eso'", 'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'release_date': ('djangoplicity.archives.fields.ReleaseDateTimeField', [], {'db_index': 'True', 'null': 'True', 'blank': 'True'}),
            'release_date_owner': ('django.db.models.fields.SlugField', [], {'db_index': 'True', 'max_length': '50', 'null': 'True', 'blank': 'True'}),
            'rights': ('djangoplicity.metadata.archives.fields.AVMRightsField', [], {'default': "''", 'null': 'True', 'blank': 'True'}),
            ...
            'subject_category': ('djangoplicity.metadata.archives.fields.AVMSubjectCategoryField', [], {'symmetrical': 'False', 'to': "orm['metadata.TaxonomyHierarchy']", 'null': 'True', 'blank': 'True'}),
            'subject_name': ('djangoplicity.metadata.archives.fields.AVMSubjectNameField', [], {'symmetrical': 'False', 'to': "orm['metadata.SubjectName']", 'null': 'True', 'blank': 'True'}),
            'tagging_status': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['metadata.TaggingStatus']", 'symmetrical': 'False', 'blank': 'True'}),
