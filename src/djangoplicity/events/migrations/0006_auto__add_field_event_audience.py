...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.audience'
        db.add_column(u'events_event', 'audience',
                      self.gf('django.db.models.fields.CharField')(default='P', max_length=1, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.audience'
        db.delete_column(u'events_event', 'audience')
    ...
    models = {
        u'events.event': {
            ...
            'audience': ('django.db.models.fields.CharField', [], {'default': "'P'", 'max_length': '1', 'db_index': 'True'}),
