...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'events_event', 'type', self.gf('django.db.models.fields.CharField')(max_length=2))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Event.type'
        db.alter_column(u'events_event', 'type', self.gf('django.db.models.fields.CharField')(max_length=1))
